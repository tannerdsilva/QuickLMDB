...
extension MDB_cursor_dupsort {
	public borrowing func opPreviousDup() throws -> MDB_cursor_dbtype.MDB_db_val_type {
...
extension MDB_cursor_dupsort {
>>>>>>> v3-dev
	public borrowing func opPreviousDup(returning:MDB_val.Type) throws -> MDB_val {
		var keyVal = MDB_val.uninitialized()
		var valueVal = MDB_val.uninitialized()
...
extension MDB_cursor {
	public borrowing func opPrevious<K, V>(transforming:(key:MDB_val, value:MDB_val).Type, keyOutTransformer:(consuming MDB_val) -> K, valueOutTransformer:(consuming MDB_val) -> V) throws -> (key:K, value:V) {
		var keyVal = MDB_val.uninitialized()
		var valueVal = MDB_val.uninitialized()
...
extension MDB_cursor_dupsort {
>>>>>>> v3-dev
	public borrowing func opPreviousDup<V>(transforming:MDB_val.Type, valueOutTransformer:(consuming MDB_val) -> V) throws -> V {
		var keyVal = MDB_val.uninitialized()
		var valueVal = MDB_val.uninitialized()
	...
	public borrowing func opPreviousNoDup<K, V>(transforming:(key:MDB_val, value:MDB_val).Type, keyOutTransformer:(consuming MDB_val) -> K, valueOutTransformer:(consuming MDB_val) -> V) throws -> (key:K, value:V) {
		var keyVal = MDB_val.uninitialized()
		var valueVal = MDB_val.uninitialized()
