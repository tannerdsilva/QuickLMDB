...
extension MDB_cursor {
	...
	// set variants
	public borrowing func opSet(key keyVal:consuming MDB_val) throws {
		try MDB_cursor_get_entry_static(cursor:self, .set, key:&keyVal)
	}
	...
	public borrowing func opSetRange(key keyVal:consuming MDB_val) throws {
		try MDB_cursor_get_entry_static(cursor:self, .setRange, key:&keyVal)
	}
}
