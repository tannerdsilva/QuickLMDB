...
let valueVal = MDB_val.uninitialized()
		...
		let entry = try MDB_cursor_get_entry(cursor:self.cursorHandle(), op:Operation.next.mdbValue, key:keyVal, value:valueVal)
...
let valueVal = MDB_val.uninitialized()
		...
		let entry = try MDB_cursor_get_entry(cursor:self.cursorHandle(), op:Operation.nextDup.mdbValue, key:keyVal, value:valueVal)
...
let valueVal = MDB_val.uninitialized()
		...
		let entry = try MDB_cursor_get_entry(cursor:self.cursorHandle(), op:Operation.nextNoDup.mdbValue, key:keyVal, value:valueVal)
