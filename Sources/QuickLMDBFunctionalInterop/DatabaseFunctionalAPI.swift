...
// set entry (key, value)
@available(*, noasync)
public func MDB_db_set_entry_static(db:MDB_dbi, key:inout CLMDB.MDB_val, value:inout CLMDB.MDB_val, flags:UInt32, tx:OpaquePointer) throws(LMDBError) {
	#if DEBUG
...
@available(*, noasync)
public func MDB_db_set_entry_static(db:MDB_dbi, returning:CLMDB.MDB_val.Type, key:inout CLMDB.MDB_val, value:inout CLMDB.MDB_val, flags:UInt32, tx:OpaquePointer) throws(LMDBError) -> CLMDB.MDB_val {
	#if DEBUG
...
@available(*, noasync)
public func MDB_db_contains_entry_static(db:MDB_dbi, key:inout CLMDB.MDB_val, value:inout CLMDB.MDB_val, tx:OpaquePointer) throws(LMDBError) -> Bool {
...
// delete entry (key)
@available(*, noasync)
public func MDB_db_delete_entry_static(db:MDB_dbi, key:inout CLMDB.MDB_val, tx:OpaquePointer) throws(LMDBError) {
...
@available(*, noasync)
public func MDB_db_delete_entry_static(db:MDB_dbi, key:inout CLMDB.MDB_val, value:inout CLMDB.MDB_val, tx:OpaquePointer) throws(LMDBError) {
...
// delete all entries
@available(*, noasync)
public func MDB_db_delete_all_entries_static(db:MDB_dbi, tx:OpaquePointer) throws(LMDBError) {
...
// delete the database
@available(*, noasync)
public func MDB_db_delete_database_static(db:MDB_dbi, tx:OpaquePointer) throws(LMDBError) {
...
// flags
@available(*, noasync)
public func MDB_db_get_flags_static(db:MDB_dbi, tx:OpaquePointer) throws(LMDBError) -> UInt32 {
...
// compare key set
@available(*, noasync)
public func MDB_db_assign_compare_key_f(db:MDB_dbi, compare:MDB_cmp_func_t, tx:OpaquePointer) {
...
// compare data set
@available(*, noasync)
public func MDB_db_assign_compare_val_f(db:MDB_dbi, compare:MDB_cmp_func_t, tx:OpaquePointer) {
